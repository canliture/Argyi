...
public class LiveVariables {
  ...
  public boolean isVariableLive(final String varName, CFANode location) {
    // 1. global variables are always live
    // 2. variables which are not in the scope of current function are regarded as live vars
    // 3. the address of this variable is used somewhere, then we regard it as live vars
