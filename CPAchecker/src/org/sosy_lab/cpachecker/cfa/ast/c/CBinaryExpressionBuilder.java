...
public class CBinaryExpressionBuilder {
  ...
  */
  ...
  public CBinaryExpression buildBinaryExpression(CExpression op1, CExpression op2, BinaryOperator op) throws UnrecognizedCCodeException {
    ...
    // FIXME: wrong FileLocation here!
    FileLocation mergedLoc = FileLocation.merge(op1.getFileLocation(), op2.getFileLocation());

    return new CBinaryExpression(mergedLoc, resultType, calculationType, op1, op2, op);
  }
