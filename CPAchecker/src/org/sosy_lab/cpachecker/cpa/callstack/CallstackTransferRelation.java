...
public class CallstackTransferRelation extends SingleEdgeTransferRelation {
  ...
  // this value is typically set to 1, by configuration files
  ...
  /*
   * if the target function appears in the calling stack more than `recursionBoundDepth', we think we have
   *   discovered a recursive calling structure
   */
  ...
  /*
   * decide whether we should go by function summary edge or function call edge
   */
  ...
  // find out an instance of FunctionCallEdge
